            ...
            <div className="p-8 overflow-y-auto custom-scrollbar space-y-10">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-12 gap-x-4 gap-y-5">
                  ...
                  <div className="col-span-12 md:col-span-4 space-y-1.5"><label className="text-[10px] font-bold text-slate-500 dark:text-gray-400 uppercase ml-1">Estado</label><input value={formData.state} onChange={e => setFormData({...formData, state: e.target.value})} className="w-full bg-slate-50 dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-xl px-2 py-3 text-slate-700 dark:text-gray-200 outline-none focus:border-sky-500 text-sm text-center" maxLength={2} placeholder="SP" /></div>
                </div>
              </div>
